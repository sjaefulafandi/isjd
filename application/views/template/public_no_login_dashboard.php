...
<body>
	<!-- Modal -->	
	<div class="modal fade bs-example-modal-sm" id="myModalPublicDashboard" tabindex="-1" role="dialog" aria-labelledby="myModalPublicDashboard" aria-hidden="true">
	  <div class="modal-dialog modal-sm-12" id="myModalPublicDashboardTarget">
	  </div>
