<div class="row-fluid col-sm-10" >
  	<form id="user_profile_penerbit_form" method="post" action="#">
		 <div class="row">
		 	 Ganti Password 
		 <div class="row">
...
$(document).ready(function(){
	 $("#user_profile_penerbit_form").validate({
    	ignore:""
	 	,rules: {
				password_lama :{
					required:true,
	 	...
	 	,errorPlacement: function(error, element) {
	  	...
	  	,submitHandler: function(form) {
        	...
        	var password_baru=$('#password_baru').val();
         	...
         	$('#pdataprofil').load(base_url+'index.php/user_public/user_penerbit_change_password/',{"password_lama":password_lama,"password_baru":password_baru},function (data){}); 
