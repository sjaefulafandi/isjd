	...
	$('#komplain_progress_detail').validate({
	    rules: {
	 	...
	 	submitHandler: function(form) {
	        ...
	        $('#modaltarget').load(base_url+'index.php/user_public/save_komplain_detail/',{"comment_complain":comment_complain,"statuskomplain":statuskomplain,"id_user_complain":id_user_complain},function (data){
	        	viewcomplaindetail(id_user_complain);
	        	//loadpanel('dKomplain');
