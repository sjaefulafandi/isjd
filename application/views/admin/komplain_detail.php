<script type="text/javascript">
	function findadminlogkomplaindetail(id_user_complain){
		...
		$('.divmask').show();
		$('#modaladmin').empty();
		$('#modaladmin').load(base_url+'index.php/admin/show_komplain_detail/'+keyword_text_komplain_detail_user+'/'+id_user_complain,{"keyword_text_komplain_detail_user":keyword_text_komplain_detail_user,"id_user_complain":id_user_complain},function (data){
			$('.divmask').hide();
			});
	}

	function add_admin_komplain_detail_form(id_user_complain){
	$('modaladmin').empty();
	//alert(id_user_complain);
	$('#modaladmin').load(base_url+'index.php/admin/show_admin_komplain_detail_form',{"id_user_complain":id_user_complain},function (data){});	
	}//ennd of add_komplain_detail_form

	function refresh_admin_komplain(){
	 $('.divmask').show();
        $('#page-wrapper').empty();
...
<div class="modal-content" >
	...
	<div class="modal-body" id="modal_komplain_detail" >
		<div class="row">
			...
			<a href="#" data-toggle="modal" onclick="add_admin_komplain_detail_form(<?php echo $id_user_complain;?>);" data-target="#myModalDetail">
			...
			<div class="panel-heading">
		  		...
		  		<div class="col-sm-5">
		    		<div class="input-group input-group-sm">
		        		...
		        		<button onclick="findadminlogkomplaindetail(<?php echo $id_user_complain;?>);" class="btn btn-default" type="button">
	...
	<div class="row-fluid modal-footer">
			 	<button type="button" class="btn btn-default btn-xs" onclick="refresh_admin_komplain();" >Close</button>
