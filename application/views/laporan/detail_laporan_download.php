...
<script>
function get_xls_download_link(tanggal_start,tanggal_end){
	//alert(tanggal_end);

	var form = document.createElement("form");
	form.setAttribute("method", "post");
	form.setAttribute("action", base_url+"index.php/admin/get_xls_download");
...
<div>
	<a href="#" onclick="get_xls_download_link('<?php echo $range_tanggal[0];?>','<?php echo $range_tanggal[1];?>')" >
