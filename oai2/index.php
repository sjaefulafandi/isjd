...
oai2/oaidp-config-server.php, most possible values and options are explained. 
...
by clicking on the <a href="http://localhost/oai2/oai2.php?verb=Identify">test links below</a>. 
<p>
...
<dt>Example Tables
  <dd><a href="doc/oai_records_mysql.txt">OAI Records (mysql)</a></dd>
  <dd><a href="doc/oai_records_pgsql.txt">OAI Records (pgsql)</a></dd>
</dt>
...
<br/>
Modified by Hendro Subagyo and Al Hafiz Akbar Maulana Siagian <br /> 
For ISJD <a href="http://www.pdii.lipi.go.id">www.pdii.lipi.go.id</a><br /> 
</font>
</blockquote>
</body>
</html>
